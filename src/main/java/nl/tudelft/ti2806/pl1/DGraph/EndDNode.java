...
/**
 * Special DNode data class for the added End Node.
 * 
 * @author Chak Shun
 *
 */
public class EndDNode extends AbstractDNode {

	/** Text for the special node to show. */
	private String specialText = "END NODE";
	 ...
	 */
	public EndDNode(final int idIn, final HashSet<String> sourcesIn,
